; iccavr asm header file for m162 - all io memory mapped
...
; UART1
UBRR1H                  =0x5C
UBRR1H_io               =0x3C  ; for IN/OUT
URSEL1                  =7
UBRR1L                  =0x20
UBRR1L_io               =0x00  ; for IN/OUT, CBI/SBI, SBIC/SBIS
UBRR1                   =0x20
UBRR1_io                =0x00  ; for IN/OUT, CBI/SBI, SBIC/SBIS
UCSR1C                  =0x5C
UCSR1C_io               =0x3C  ; for IN/OUT
URSEL1                  =7
UMSEL1                  =6
UPM11                   =5
UPM10                   =4
...
UCPOL1                  =0
UCSR1B                  =0x21
UCSR1B_io               =0x01  ; for IN/OUT, CBI/SBI, SBIC/SBIS
RXCIE1                  =7
TXCIE1                  =6
UDRIE1                  =5
RXEN1                   =4
...
TXB81                   =0
UCSR1A                  =0x22
UCSR1A_io               =0x02  ; for IN/OUT, CBI/SBI, SBIC/SBIS
RXC1                    =7
TXC1                    =6
UDRE1                   =5
FE1                     =4
...
MPCM1                   =0
UDR1                    =0x23
UDR1_io                 =0x03  ; for IN/OUT, CBI/SBI, SBIC/SBIS
;
; UART0
UBRR0H                  =0x40
UBRR0H_io               =0x20  ; for IN/OUT
URSEL0                  =7
UBRR0L                  =0x29
UBRR0L_io               =0x09  ; for IN/OUT, CBI/SBI, SBIC/SBIS
UBRR0                   =0x29
UBRR0_io                =0x09  ; for IN/OUT, CBI/SBI, SBIC/SBIS
UCSR0C                  =0x40
UCSR0C_io               =0x20  ; for IN/OUT
URSEL0                  =7
UMSEL0                  =6
UPM01                   =5
UPM00                   =4
...
; Port E
PINE                    =0x25
PINE_io                 =0x05  ; for IN/OUT, CBI/SBI, SBIC/SBIS
DDRE                    =0x26
DDRE_io                 =0x06  ; for IN/OUT, CBI/SBI, SBIC/SBIS
PORTE                   =0x27
PORTE_io                =0x07  ; for IN/OUT, CBI/SBI, SBIC/SBIS
;
; Port D
PIND                    =0x30
...
; Timer/Counter2
ASSR                    =0x46
ASSR_io                 =0x26  ; for IN/OUT
AS2                     =3
TCN2UB                  =2
OCR2UB                  =1
TCR2UB                  =0
OCR2                    =0x42
OCR2_io                 =0x22  ; for IN/OUT
TCNT2                   =0x43
TCNT2_io                =0x23  ; for IN/OUT
TCCR2                   =0x47
TCCR2_io                =0x27  ; for IN/OUT
FOC2                    =7
WGM20                   =6
COM21                   =5
COM20                   =4
...
; Timer/Counter1
ICR1                    =0x44
ICR1_io                 =0x24  ; for IN/OUT
ICR1L                   =0x44
ICR1L_io                =0x24  ; for IN/OUT
ICR1H                   =0x45
ICR1H_io                =0x25  ; for IN/OUT
OCR1B                   =0x48
...
; JTAG Debug Register
OCDR                    =0x24
OCDR_io                 =0x04  ; for IN/OUT, CBI/SBI, SBIC/SBIS
;
; OSC Calibration Register
OSCCAL                  =0x24
OSCCAL_io               =0x04  ; for IN/OUT, CBI/SBI, SBIC/SBIS
;
; Clock Prescaler
CLKPR                   =0x61
CLKPCE                  =7
