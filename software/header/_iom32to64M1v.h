#ifndef ___iom32to64M1v_h
#define ___iom32to64M1v_h

/* ATmega32..64M1 header file for
 * ImageCraft ICCAVR compiler
 */

/* 2008-03-10   derived from io64C1v.h
...
/* PSC registers */
#define POCR0SA	(*(volatile unsigned int *)0xa0)
#define POCR0SAL	(*(volatile unsigned char *)0xa0)
#define POCR0SAH	(*(volatile unsigned char *)0xa1)
#define POCR0RA	(*(volatile unsigned int *)0xa2)
#define POCR0RAL	(*(volatile unsigned char *)0xa2)
#define POCR0RAH	(*(volatile unsigned char *)0xa3)
#define POCR0SB	(*(volatile unsigned int *)0xa4)
#define POCR0SBL	(*(volatile unsigned char *)0xa4)
#define POCR0SBH	(*(volatile unsigned char *)0xa5)
#define POCR1SA	(*(volatile unsigned int *)0xa6)
#define POCR1SAL	(*(volatile unsigned char *)0xa6)
#define POCR1SAH	(*(volatile unsigned char *)0xa7)
#define POCR1RA	(*(volatile unsigned int *)0xa8)
#define POCR1RAL	(*(volatile unsigned char *)0xa8)
#define POCR1RAH	(*(volatile unsigned char *)0xa9)
#define POCR1SB	(*(volatile unsigned int *)0xaa)
#define POCR1SBL	(*(volatile unsigned char *)0xaa)
#define POCR1SBH	(*(volatile unsigned char *)0xab)
#define POCR2SA	(*(volatile unsigned int *)0xac)
#define POCR2SAL	(*(volatile unsigned char *)0xac)
#define POCR2SAH	(*(volatile unsigned char *)0xad)
#define POCR2RA	(*(volatile unsigned int *)0xae)
#define POCR2RAL	(*(volatile unsigned char *)0xae)
#define POCR2RAH	(*(volatile unsigned char *)0xaf)
#define POCR2SB	(*(volatile unsigned int *)0xb0)
#define POCR2SBL	(*(volatile unsigned char *)0xb0)
#define POCR2SBH	(*(volatile unsigned char *)0xb1)
#define POCR_RB	(*(volatile unsigned int *)0xb2)
#define POCR_RBL	(*(volatile unsigned char *)0xb2)
#define POCR_RBH	(*(volatile unsigned char *)0xb3)
#define PSYNC	(*(volatile unsigned int *)0xb2)
#define  PSYNC21  5
#define  PSYNC20  4
#define  PSYNC11  3
#define  PSYNC10  2
#define  PSYNC01  1
#define  PSYNC00  0
#define PCNF	(*(volatile unsigned int *)0xb2)
#define  PULOCK1  5
#define  PMODE    4
#define  POPB     3
#define  POPA     2
#define POC 	(*(volatile unsigned int *)0xb2)
#define  POEN2B   1
#define  POEN2A   0
#define  POEN1B   1
#define  POEN1A   0
#define  POEN0B   1
#define  POEN0A   0
#define PCTL	(*(volatile unsigned int *)0xb2)
#define  PPRE1    7
#define  PPRE0    6
#define  PCLKSEL  5
#define  PCCYC    1
#define  PRUN     0
#define PMIC0	(*(volatile unsigned int *)0xb2)
#define  POVEN0   7
#define  PISEL0   6
#define  PELEV0   5
#define  PFLTE0   4
...
#define  PRFM01   1
#define  PRFM00   0
#define PMIC1	(*(volatile unsigned int *)0xb2)
#define  POVEN1   7
#define  PISEL1   6
#define  PELEV1   5
#define  PFLTE1   4
...
#define  PRFM11   1
#define  PRFM10   0
#define PMIC2	(*(volatile unsigned int *)0xb2)
#define  POVEN2   7
#define  PISEL2   6
#define  PELEV2   5
#define  PFLTE2   4
...
#define  PRFM21   1
#define  PRFM20   0
#define PIM 	(*(volatile unsigned int *)0xb2)
#define  PEVE2    3
#define  PEVE1    2
#define  PEVE0    1
#define  PEOEP    0
#define PIFR	(*(volatile unsigned int *)0xb2)
#define  PEV2     3
#define  PEV1     2
#define  PEV0     1
#define  PEOP     0
