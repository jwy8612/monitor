...
/* 2008/06/18   alpha based on early datasheets
   ...
   2009/04/16   fully revised, many changes
   2009/05/05   added new NVM fuses names
 */
...
#define DFLL_CALL_gp 1 /* DFLL Calibration bits [6:0] group position. */
...
/* */
#define NVM_FUSES_WDPD_8CLK_gc (0x00<<4) /* 8 cycles (8ms @ 3.3V) */
#define NVM_FUSES_WDPD_16CLK_gc (0x01<<4) /* 16 cycles (16ms @ 3.3V) */
#define NVM_FUSES_WDPD_32CLK_gc (0x02<<4) /* 32 cycles (32ms @ 3.3V) */
#define NVM_FUSES_WDPD_64CLK_gc (0x03<<4) /* 64 cycles (64ms @ 3.3V) */
#define NVM_FUSES_WDPD_128CLK_gc (0x04<<4) /* 128 cycles (0.125s @ 3.3V) */
#define NVM_FUSES_WDPD_256CLK_gc (0x05<<4) /* 256 cycles (0.25s @ 3.3V) */
#define NVM_FUSES_WDPD_512CLK_gc (0x06<<4) /* 512 cycles (0.5s @ 3.3V) */
#define NVM_FUSES_WDPD_1KCLK_gc (0x07<<4) /* 1K cycles (1s @ 3.3V) */
#define NVM_FUSES_WDPD_2KCLK_gc (0x08<<4) /* 2K cycles (2s @ 3.3V) */
#define NVM_FUSES_WDPD_4KCLK_gc (0x09<<4) /* 4K cycles (4s @ 3.3V) */
#define NVM_FUSES_WDPD_8KCLK_gc (0x0A<<4) /* 8K cycles (8s @ 3.3V) */
...
#define NVM_FUSES_RSTDISBL_bm 0x10 /* Reset Disable mask */
...
#define NVM_FUSES_BODLEVEL_gm 0x07 /* Brown Out Detection Voltage Level group mask. */
#define NVM_FUSES_BODLEVEL_gp 0 /* Brown Out Detection Voltage Level group position. */
/* */
...
#define ADC_CH_MUXPOS_gm 0x38 /* Positive Input Select group mask. */
...
#define ADC_CH_MUXINT_TEMP_gc (0x00<<3) /* Bandgap Reference */
...
#define ADC_CH_INTMODE_BELOW_gc (0x01<<2) /* Interrupt on Value Below */
#define ADC_CH_INTMODE_ABOVE_gc (0x03<<2) /* Interrupt on Value Above */
/* */
#define ADC_CH_INTLVL_OFF_gc (0x00<<0) /* Interrupt Levels */
#define ADC_CH_INTLVL_LO_gc (0x01<<0) /* */
#define ADC_CH_INTLVL_MED_gc (0x02<<0) /* */
#define ADC_CH_INTLVL_HI_gc (0x03<<0) /* */
...
#define ADC_REFSEL_INTVCC_gc (0x01<<4) /* Internal VCC-0.6V */
#define ADC_REFSEL_AREFA_gc (0x02<<4) /* External reference */
#define ADC_REFSEL_AREFB_gc (0x03<<4) /* External reference */
...
/* */
#define DAC_REFSEL_INT1V_gc (0x00<<3) /* Internal 1V Bandgap */
#define DAC_REFSEL_AVCC_gc (0x01<<3) /* Analog supply voltage */
#define DAC_REFSEL_AREFA_gc (0x02<<3) /* External reference */
#define DAC_REFSEL_AREFB_gc (0x03<<3) /* External reference */
...
/* */
#define DAC_CONINTVAL_1CLK_gc (0x00<<4) /* 1 CLK */
#define DAC_CONINTVAL_2CLK_gc (0x01<<4) /* 2 CLK */
#define DAC_CONINTVAL_4CLK_gc (0x02<<4) /* 4 CLK */
#define DAC_CONINTVAL_8CLK_gc (0x03<<4) /* 8 CLK */
#define DAC_CONINTVAL_16CLK_gc (0x04<<4) /* 16 CLK */
#define DAC_CONINTVAL_32CLK_gc (0x05<<4) /* 32 CLK */
#define DAC_CONINTVAL_64CLK_gc (0x06<<4) /* 64 CLK */
#define DAC_CONINTVAL_128CLK_gc (0x07<<4) /* 128 CLK */
/* */
...
/* */
#define EBI_CS_SRWS_0CLK_gc (0x00) /* 0 Wait Cycles */
#define EBI_CS_SRWS_1CLK_gc (0x01) /* 1 Wait Cycle */
#define EBI_CS_SRWS_2CLK_gc (0x02) /* 2 Wait Cycles */
#define EBI_CS_SRWS_3CLK_gc (0x03) /* 3 Wait Cycles */
#define EBI_CS_SRWS_4CLK_gc (0x04) /* 4 Wait Cycles */
#define EBI_CS_SRWS_5CLK_gc (0x05) /* 5 Wait Cycles */
#define EBI_CS_SRWS_6CLK_gc (0x06) /* 6 Wait Cycles */
#define EBI_CS_SRWS_7CLK_gc (0x07) /* 7 Wait Cycles */
/* */
...
/* AWEX.CTRL masks */
#define AWEX_FDACT_gm 0xC0 /* Fault Detect Action group mask. */
...
#define USART_BSELH_gm 0x0F /* Baud Rate Selection Bits [11:8] group mask. */
#define USART_BSELH_gp 0 /* Baud Rate Selection Bits [11:8] group position. */
...
#define IRCOM_EVSEL0_gc (0x08) /* Event Channel 0 */
#define IRCOM_EVSEL1_gc (0x09) /* Event Channel 1 */
#define IRCOM_EVSEL2_gc (0x0A) /* Event Channel 2 */
#define IRCOM_EVSEL3_gc (0x0B) /* Event Channel 3 */
#define IRCOM_EVSEL4_gc (0x0C) /* Event Channel 4 */
#define IRCOM_EVSEL5_gc (0x0D) /* Event Channel 5 */
#define IRCOM_EVSEL6_gc (0x0E) /* Event Channel 6 */
#define IRCOM_EVSEL7_gc (0x0F) /* Event Channel 7 */

#define IRDA_EVSEL_OFF_gc (0x00) /* No Event Source */
#define IRDA_EVSEL_0_gc (0x08) /* Event Channel 0 */
#define IRDA_EVSEL_1_gc (0x09) /* Event Channel 1 */
#define IRDA_EVSEL_2_gc (0x0A) /* Event Channel 2 */
#define IRDA_EVSEL_3_gc (0x0B) /* Event Channel 3 */
#define IRDA_EVSEL_4_gc (0x0C) /* Event Channel 4 */
#define IRDA_EVSEL_5_gc (0x0D) /* Event Channel 5 */
#define IRDA_EVSEL_6_gc (0x0E) /* Event Channel 6 */
#define IRDA_EVSEL_7_gc (0x0F) /* Event Channel 7 */
