#ifndef ___xmA1bits_h
#define ___xmA1bits_h

/* XMegaXXXA1 io bits and values header file
 * to be included by ioxmXXXA1v.h
 */

/* 2008/03/09   alpha based on Astudio 4.14.0.580 part description
                defining _gm, _gc and _bm masks/values, no _bp yet
 */

/* there are differences between astudio's xml file
   and datasheet. i guess for xml file...
*/
...
#define DMA_CH_BURSTLEN0_bm (1) /* Channel Transfer Mode bit 0 */
#define DMA_CH_BURSTLEN1_bm (1<<1) /* Channel Transfer Mode bit 1 */
...
#define PORTCFG_CLKOUT_gm 0x30 /* Clock Output Port */
#define PORTCFG_EVOUT_gm 0x03 /* Event Output Port */
...
/* Clock Output Port */
#define PORTCFG_CLKOUT_OFF_gc (0x00<<4) /* Clock Output Disabled */
#define PORTCFG_CLKOUT_PC7_gc (0x01<<4) /* Clock Output on Port C pin 7 */
#define PORTCFG_CLKOUT_PD7_gc (0x02<<4) /* Clock Output on Port D pin 7 */
#define PORTCFG_CLKOUT_PE7_gc (0x03<<4) /* Clock Output on Port E pin 7 */

/* Event Output Port */
#define PORTCFG_EVOUT_OFF_gc (0x00) /* Event Output Disabled */
#define PORTCFG_EVOUT_PC7_gc (0x01) /* Event Channel 7 Output on Port C pin 7 */
#define PORTCFG_EVOUT_PD7_gc (0x02) /* Event Channel 7 Output on Port D pin 7 */
#define PORTCFG_EVOUT_PE7_gc (0x03) /* Event Channel 7 Output on Port E pin 7 */
