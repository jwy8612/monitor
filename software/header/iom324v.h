...
/* 2005/06/14 created
   2005/09/10 fixed iv_TIMER2_COMPB/OVF + TWAM(R)
   2006/02/11 fixed __iom324v_h and CKOUT
 */
...
#define  TWEN     2
#define  TWIE     0
#define TWAM	(*(volatile unsigned char *)0xBD) /* m/m */
...
#define PCMSK3	(*(volatile unsigned char *)0x73) /* m/m */
