#ifndef ___xmA1iors_h
#define ___xmA1iors_h

/* XMegaXXXA1 io header file
 * for ImageCraft ICCAVR compiler
 */

/* 2008/06/05   created
   2008/07/08   added missing IRCOM, swapped to _xmAbits.h
   2008/08/07   removed OCD ior, reworked interrupt vectors
   2009/04/08   removed "#include <_xmA1flatio.h>"
...
#define iv_TWID_MASTER  76
#define iv_TWID_SLAVE   77
...
#define iv_PORTQ_INT0   95
#define iv_PORTQ_INT1   96

#define iv_PORTH_INT0   97
#define iv_PORTH_INT1   98

#define iv_PORTJ_INT0   99
#define iv_PORTJ_INT1   100

#define iv_PORTK_INT0   101
#define iv_PORTK_INT1   102

/* reserved:
#define iv_PORTL_INT0   103
#define iv_PORTL_INT1   104
*/

#define iv_PORTF_INT0   105
#define iv_PORTF_INT1   106

#define iv_TWIF_MASTER  107
#define iv_TWIF_SLAVE   108
...
#define iv_TCF1_OVF     115
#define iv_TCF1_ERR     116
#define iv_TCF1_CCA     117
#define iv_TCF1_CCB     118

#define iv_SPIF_INT     119
#define iv_SPIF_SPI     119
#define iv_SPIF         119

#define iv_USARTF0_RXC  120
#define iv_USARTF0_DRE  121
#define iv_USARTF0_TXC  122
#define iv_USARTF1_RXC  123
#define iv_USARTF1_DRE  124
#define iv_USARTF1_TXC  125
