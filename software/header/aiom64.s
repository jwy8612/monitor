; iccavr asm header file for m64
...
;
; Port G
PING                    =0x63  ; memory mapped, for LD/ST
DDRG                    =0x64  ; memory mapped, for LD/ST
PORTG                   =0x65  ; memory mapped, for LD/ST
;
; Port F
PINF                    =0x00  ; for IN/OUT, CBI/SBI, SBIC/SBIS
DDRF                    =0x61  ; memory mapped, for LD/ST
PORTF                   =0x62  ; memory mapped, for LD/ST
;
; Port E
PINE                    =0x01  ; for IN/OUT, CBI/SBI, SBIC/SBIS
DDRE                    =0x02  ; for IN/OUT, CBI/SBI, SBIC/SBIS
PORTE                   =0x03  ; for IN/OUT, CBI/SBI, SBIC/SBIS
;
; Port D
...
;
; ADC
ADC                     =0x04  ; for IN/OUT, CBI/SBI, SBIC/SBIS
ADCL                    =0x04  ; for IN/OUT, CBI/SBI, SBIC/SBIS
ADCH                    =0x05  ; for IN/OUT, CBI/SBI, SBIC/SBIS
ADCSRB                  =0x8E  ; memory mapped, for LD/ST
ADTS2                   =2
ADTS1                   =1
ADTS0                   =0
ADCSRA                  =0x06  ; for IN/OUT, CBI/SBI, SBIC/SBIS
ADEN                    =7
ADSC                    =6
ADFR                    =5
ADATE                   =5
...
ADPS1                   =1
ADPS0                   =0
ADMUX                   =0x07  ; for IN/OUT, CBI/SBI, SBIC/SBIS
REFS1                   =7
REFS0                   =6
ADLAR                   =5
MUX4                    =4
...
;
; USART0
UBRR0H                  =0x90  ; memory mapped, for LD/ST
UBRR0L                  =0x09  ; for IN/OUT, CBI/SBI, SBIC/SBIS
UCSR0C                  =0x95  ; memory mapped, for LD/ST
UMSEL0                  =6
UPM01                   =5
UPM00                   =4
USBS0                   =3
...
;
; USART1
UBRR1H                  =0x98  ; memory mapped, for LD/ST
UBRR1L                  =0x99  ; memory mapped, for LD/ST
UCSR1C                  =0x9D  ; memory mapped, for LD/ST
UMSEL1                  =6
UPM11                   =5
UPM10                   =4
USBS1                   =3
...
UCSZ10                  =1
UCPOL1                  =0
UCSR1B                  =0x9A  ; memory mapped, for LD/ST
RXCIE1                  =7
TXCIE1                  =6
UDRIE1                  =5
RXEN1                   =4
...
RXB81                   =1
TXB81                   =0
UCSR1A                  =0x9B  ; memory mapped, for LD/ST
RXC1                    =7
TXC1                    =6
UDRE1                   =5
FE1                     =4
...
U2X1                    =1
MPCM1                   =0
UDR1                    =0x9C  ; memory mapped, for LD/ST
;
; 2-wire SI
TWBR                    =0x70  ; memory mapped, for LD/ST
TWSR                    =0x71  ; memory mapped, for LD/ST
TWPS1                   =1
TWPS0                   =0
TWAR                    =0x72  ; memory mapped, for LD/ST
TWGCE                   =0
TWDR                    =0x73  ; memory mapped, for LD/ST
TWCR                    =0x74  ; memory mapped, for LD/ST
TWINT                   =7
TWEA                    =6
TWSTA                   =5
TWSTO                   =4
...
SFIOR                   =0x20  ; for IN/OUT, CBI/SBI, SBIC/SBIS
TSM                     =7
ADHSM                   =4
ACME                    =3
PUD                     =2
...
OCR3C                   =0x82  ; memory mapped, for LD/ST
OCR3CL                  =0x82  ; memory mapped, for LD/ST
OCR3CH                  =0x83  ; memory mapped, for LD/ST
...
TCCR3C                  =0x8C  ; memory mapped, for LD/ST
FOC3A                   =7
FOC3B                   =6
FOC3C                   =5
...
;
; Timer/Counter2
OCR2                    =0x23  ; for IN/OUT
TCNT2                   =0x24  ; for IN/OUT
TCCR2                   =0x25  ; for IN/OUT
FOC2                    =7
WGM20                   =6
COM21                   =5
COM20                   =4
...
;
; Timer/Counter1
ICR1                    =0x26  ; for IN/OUT
ICR1L                   =0x26  ; for IN/OUT
ICR1H                   =0x27  ; for IN/OUT
OCR1C                   =0x78  ; memory mapped, for LD/ST
OCR1CL                  =0x78  ; memory mapped, for LD/ST
OCR1CH                  =0x79  ; memory mapped, for LD/ST
...
TCCR1C                  =0x7A  ; memory mapped, for LD/ST
FOC1A                   =7
FOC1B                   =6
FOC1C                   =5
...
OSCCAL                  =0x6F  ; memory mapped, for LD/ST
;
; MCU
...
SPMCSR                  =0x68  ; memory mapped, for LD/ST
SPMIE                   =7
RWWSB                   =6
RWWSRE                  =4
BLBSET                  =3
...
ISC41                   =1
ISC40                   =0
EICRA                   =0x6A  ; memory mapped, for LD/ST
ISC31                   =7
ISC30                   =6
ISC21                   =5
ISC20                   =4
...
XMCRB                   =0x6C  ; memory mapped, for LD/ST
XMBK                    =7
XMM2                    =2
XMM1                    =1
XMM0                    =0
XMCRA                   =0x6D  ; memory mapped, for LD/ST
SRL2                    =6
SRL1                    =5
SRL0                    =4
SRW01                   =3
