...
/* ATtinyX8 register and bit name header file
 * for ImageCraft ICC7AVR compiler
 */

/* 2008/06/04	created
   2009/04/29	added SPMCSR,RWWSB for compatibility (see datasheet)
 */
...
/* Port A */
#define PINA	(*(volatile unsigned char *)0x2C)
#define DDRA	(*(volatile unsigned char *)0x2D)
#define PORTA	(*(volatile unsigned char *)0x2E)
...
#define  TWAM1    2
#define  TWAM0    1
#define TWHSR	(*(volatile unsigned char *)0xBE) /* m/m */
#define  TWIHS    0
...
#define  RWWSB    6 /* for compatibility */
#define  CTPB     4
#define  RFLB     3
#define  PGWRT    2
#define  PGERS    1
...
/* PCMSK registers */
#define PCMSK3	(*(volatile unsigned char *)0x6A)
#define  PCINT27  3
#define  PCINT26  2
#define  PCINT25  1
#define  PCINT24  0
...
#define iv_PCINT3       7
#define iv_WDT          8
#define iv_TIMER1_CAPT  9
#define iv_TIM1_CAPT    9
#define iv_TIMER1_COMPA 10
#define iv_TIM1_COMPA   10
#define iv_TIMER1_COMPB 11
#define iv_TIM1_COMPB   11
